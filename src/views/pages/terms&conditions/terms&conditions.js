        ...
        <section id="terms" className="terms section-bg">
          <div className="container" data-aos="fade-up">
            <div className="section-title">
              <br></br>
              <br></br>
              <h3><span>MUNWell</span> Terms & Conditions</h3>
              <div style={{ textAlign: "left" }}>
                ...
                <p>We employ the use of cookies. By accessing munwell.com, you agreed to use cookies in agreement with the MUNWell, LLC's Privacy Policy.</p>
                ...
                <p>
                  <br></br>
                  <h5><strong>Hyperlinking</strong></h5>
                  <hr></hr>
                </p>
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of MUNWell, LLC; and (d) the link is in the context of general resource information.</p>
                <p>These organizations may link to our home page so long as the link: (a) is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products or services; and (c) fits within the context of the linking party’s site.</p>
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an email to MUNWell, LLC. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.</p>
                <p>Approved organizations may hyperlink to our Website as follows:</p>
                <p><ul>
                  <li>By use of our corporate name; or</li>
                  <li>By use of the uniform resource locator being linked to; or</li>
                  <li>By use of any other description of our Website being linked to that makes sense within the context and format of content on the linking party’s site.</li>                  </ul></p>
                <p>No use of MUNWell, LLC's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
                <p>
                  <br></br>
                ...
                <p>
                  <br></br>
                  <h5><strong>Removal of Links</strong></h5>
                  <hr></hr>
                </p>
                ...
                <p>Given the beta nature of the MUNWell application, MUNWell, LLC is not liable for any loss of data or damage of any nature.</p>
              </div>
            </div>
          </div>
        </section >
      ...
      <div style={{ height: "10px" }}>
        <footer id="footer">
          <div className="footerDIV">
            <p className="footerLink"><i>The Future of Organizing </i><a href="/"><strong style={{ color: "#321fdb" }}>MUNWell</strong></a></p>
